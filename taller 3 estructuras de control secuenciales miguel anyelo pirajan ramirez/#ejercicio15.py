#ejercicio15
edad = int(input("Introduce la edad en meses (para menores de 1 año) o en años: "))
sexo = input("Introduce el sexo (M para masculino, F para femenino): ")
nivel_hemoglobina = float(input("Introduce el nivel de hemoglobina en g%: "))
